...
import com.tencentcloudapi.iai.v20180301.models.FaceAttributesInfo;
import com.tencentcloudapi.iai.v20180301.models.FaceQualityInfo;
...
魅力( beauty )、眼镜( glass )、口罩（mask）、头发（hair）和姿态 (pitch，roll，yaw )。只有当 NeedFaceAttributes 设为 1 时才返回有效信息。
    */
    ...
    @Expose
    private com.tencentcloudapi.iai.v20180301.models.FaceAttributesInfo FaceAttributesInfo;
...
注意：此字段可能返回 null，表示取不到有效值。
    */
    ...
    @Expose
    private com.tencentcloudapi.iai.v20180301.models.FaceQualityInfo FaceQualityInfo;
