...
public class ClientProfile {
     ...
     */
	private com.tencentcloudapi.common.profile.HttpProfile httpProfile;
	 ...
	 */
    public ClientProfile(String signMethod, com.tencentcloudapi.common.profile.HttpProfile httpProfile) {
    ...
    public ClientProfile(String signMethod) {
        this(signMethod, new com.tencentcloudapi.common.profile.HttpProfile());
    }
	
	public ClientProfile() {
		this(ClientProfile.SIGN_TC3_256, new com.tencentcloudapi.common.profile.HttpProfile());
	}
	 ...
	 */
	public void setHttpProfile(com.tencentcloudapi.common.profile.HttpProfile httpProfile) {
		this.httpProfile = httpProfile;
	}
