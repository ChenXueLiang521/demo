...
abstract public class AbstractClient {
    ...
    private com.tencentcloudapi.common.Credential credential;
    ...
    public AbstractClient(String endpoint, String version, com.tencentcloudapi.common.Credential credential, String region) {
     ...
     *            认证信息实例
     */
    public void setCredential(com.tencentcloudapi.common.Credential credential) {
        this.credential = credential;
    }
    ...
    public String call(String action, String jsonPayload) throws TencentCloudSDKException {
        ...
        if (this.profile.isUnsignedPayload()) {
            hashedRequestPayload = com.tencentcloudapi.common.Sign.sha256Hex("UNSIGNED-PAYLOAD".getBytes());
        } else {
            hashedRequestPayload = com.tencentcloudapi.common.Sign.sha256Hex(requestPayload);
        }
        ...
        String hashedCanonicalRequest = com.tencentcloudapi.common.Sign.sha256Hex(canonicalRequest.getBytes());
        String stringToSign = "TC3-HMAC-SHA256\n" + timestamp + "\n" + credentialScope + "\n" + hashedCanonicalRequest;

        String secretId = this.credential.getSecretId();
        String secretKey = this.credential.getSecretKey();
        byte[] secretDate = com.tencentcloudapi.common.Sign.hmac256(("TC3" + secretKey).getBytes(), date);
        byte[] secretService = com.tencentcloudapi.common.Sign.hmac256(secretDate, service);
        byte[] secretSigning = com.tencentcloudapi.common.Sign.hmac256(secretService, "tc3_request");
        String signature = DatatypeConverter.printHexBinary(com.tencentcloudapi.common.Sign.hmac256(secretSigning, stringToSign)).toLowerCase();
        ...
        com.tencentcloudapi.common.JsonResponseModel<JsonResponseErrModel> errResp = null;
        try {
            Type errType = new TypeToken<com.tencentcloudapi.common.JsonResponseModel<JsonResponseErrModel>>() {
            }.getType();
    ...
    private Response doRequestWithTC3(String endpoint, AbstractModel request, String action) throws TencentCloudSDKException {
        ...
        if ( binaryParams.length > 0 ) {
            ...
            requestPayload = com.tencentcloudapi.common.AbstractModel.toJsonString(request).getBytes();
            // okhttp always set charset even we don't specify it,
            // to ensure signature be correct, we have to set it here as well.
    ...
    private String formatRequestData(String action, Map<String, String> param) throws TencentCloudSDKException {
        ...
        String sigInParam = com.tencentcloudapi.common.Sign.makeSignPlainText(new TreeMap<String, String>(param),
